"""
Base Django settings for product_importer project.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DB', default='product_importer'),
...
DATA_UPLOAD_MAX_MEMORY_SIZE = config('MAX_MEMORY_SIZE', default=52428800, cast=int)  # 50MB
